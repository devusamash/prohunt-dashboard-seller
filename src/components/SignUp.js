...
import { allCompanies } from "../app/Actions/Companyactions";
...
const SignUp = () => {
  ...
  const onFinish = (values) => {
    const payload = JSON.stringify({ user: values });
    console.log("Success:", JSON.stringify({ user: values }));
        ...
        <Content className="p-0">
          ...
          >
            ...
            >
              ...
              >
                <Input.Password placeholder="Passwoed" />
              </Form.Item>
