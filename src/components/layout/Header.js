...
function Header({
  ...
  // const isloged = useSelector(state => state.User.isLoaded)
      ...
      <Row gutter={[24, 0]}>
        <Col span={24} md={6}>
          ...
          <div className="ant-page-header-heading">
            ...
            >
              {subName.replace("/", "").match(/[A-Z][a-z]+|[0-9]+/g)}
            </span>
          </div>
        </Col>
        <Col span={24} md={18} className="header-control">
          ...
          <Button type="text" onClick={handleSignOut} className="btn-sign-in">
            {profile}
            <span>Sign out</span>
          </Button>
          <Input
